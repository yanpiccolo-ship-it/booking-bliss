...
const phases: Phase[] = [
  ...
  },
  {
    ...
    percent: 100,
    items: [
      { label: "Availability Engine (resource_types, resources, availability_rules)", done: true },
      { label: "Resource Assignment Engine (auto-assign)", done: true },
      { label: "check_resource_availability() función DB", done: true },
      { label: "assign_best_resource() función DB", done: true },
      { label: "check-availability Edge Function", done: true },
      { label: "Conflict detection & overbooking prevention", done: true },
      { label: "Resource exceptions (holidays, closures)", done: true },
      { label: "ResourceManager UI (tipos, recursos, horarios)", done: true },
  ...
  },
  {
    ...
    percent: 75,
    items: [
      { label: "Dashboard de métricas reales (ingresos, ocupación)", done: true },
      { label: "Gráficos Recharts (área, pie, barras)", done: true },
      { label: "Reportes por servicio y estado", done: true },
  ...
  },
  {
    ...
    percent: 75,
    items: [
      { label: "Auto-confirmación de reservas pendientes", done: true },
      { label: "No-show detection automática", done: true },
      { label: "Completado automático de reservas pasadas", done: true },
      { label: "Listado de recordatorios próximos", done: true },
      { label: "Envío real de emails/WhatsApp", done: false },
