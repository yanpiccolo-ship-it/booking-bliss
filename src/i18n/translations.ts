...
export const translations: Record<Language, Translations> = {
  en: {
    ...
    pricing: {
      ...
      sectionTitle: 'Plans designed for growth',
      sectionSubtitle: 'From first reservations to full automation. Choose your starting point.',
      popular: 'Most Popular',
      startAt: 'Starting at',
      selectPlan: 'Select Plan',
      contactSales: 'Contact Sales',
      monthlyFee: '+ €99/month maintenance',
      languagesSupported: 'Languages supported: EN, ES, IT, FR, PT, DE',
      plans: {
        basic: {
          name: 'Basic',
          description: 'For businesses starting their digital transformation.',
          features: ['1 category/vertical', 'WhatsApp support', 'Basic panel', 'Initial AI tasks', 'Email support'],
        },
        advanced: {
          name: 'Advanced',
          description: 'For businesses seeking full automation.',
          features: ['Multiple categories', 'Digital menu + PDF + QR', 'Programming & stock', 'Multi-language', 'Editorial backend', 'Priority support'],
        },
        custom: {
          name: 'Custom',
          description: 'Scalable solution with no limits.',
          features: ['Unlimited modules', 'Total automation', 'Travel, coworking, workshops', 'AI-generated content', 'Dedicated support', 'Custom integrations'],
        },
      },
    },
    cta: {
  ...
  es: {
    ...
    pricing: {
      ...
      sectionTitle: 'Planes diseñados para crecer',
      sectionSubtitle: 'Desde las primeras reservas hasta la automatización total. Elige tu punto de partida.',
      popular: 'Más Popular',
      startAt: 'Desde',
      selectPlan: 'Elegir Plan',
      contactSales: 'Contactar Ventas',
      monthlyFee: '+ €99/mes mantenimiento',
      languagesSupported: 'Idiomas soportados: EN, ES, IT, FR, PT, DE',
      plans: {
        basic: {
          name: 'Básico',
          description: 'Para negocios que inician su transformación digital.',
          features: ['1 rubro/vertical', 'Soporte WhatsApp', 'Panel básico', 'Tareas AI iniciales', 'Soporte email'],
        },
        advanced: {
          name: 'Avanzado',
          description: 'Para negocios que buscan automatización total.',
          features: ['Rubros múltiples', 'Menú digital + PDF + QR', 'Programación y stock', 'Multi-idioma', 'Backend editorial', 'Soporte prioritario'],
        },
        custom: {
          name: 'Personalizado',
          description: 'Solución escalable sin límites.',
          features: ['Módulos ilimitados', 'Automatización total', 'Travel, coworking, workshops', 'Contenido generado por AI', 'Soporte dedicado', 'Integraciones custom'],
        },
      },
    },
    cta: {
  ...
  it: {
    ...
    pricing: {
      sectionLabel: 'Prezzi',
      sectionTitle: 'Piani progettati per crescere',
      sectionSubtitle: 'Dalle prime prenotazioni all\'automazione totale. Scegli il tuo punto di partenza.',
      popular: 'Più Popolare',
      startAt: 'A partire da',
      selectPlan: 'Scegli Piano',
      contactSales: 'Contatta Vendite',
      monthlyFee: '+ €99/mese manutenzione',
      languagesSupported: 'Lingue supportate: EN, ES, IT, FR, PT, DE',
      plans: {
        basic: {
          name: 'Base',
          description: 'Per business che iniziano la trasformazione digitale.',
          features: ['1 categoria/verticale', 'Supporto WhatsApp', 'Pannello base', 'Task AI iniziali', 'Supporto email'],
        },
        advanced: {
          name: 'Avanzato',
          description: 'Per business che cercano automazione totale.',
          features: ['Categorie multiple', 'Menu digitale + PDF + QR', 'Programmazione e stock', 'Multi-lingua', 'Backend editoriale', 'Supporto prioritario'],
        },
        custom: {
          name: 'Personalizzato',
          description: 'Soluzione scalabile senza limiti.',
          features: ['Moduli illimitati', 'Automazione totale', 'Travel, coworking, workshop', 'Contenuti generati da AI', 'Supporto dedicato', 'Integrazioni custom'],
        },
      },
    },
    cta: {
  ...
  fr: {
    ...
    pricing: {
      sectionLabel: 'Tarifs',
      sectionTitle: 'Plans conçus pour la croissance',
      sectionSubtitle: 'Des premières réservations à l\'automatisation totale. Choisissez votre point de départ.',
      popular: 'Plus Populaire',
      startAt: 'À partir de',
      selectPlan: 'Choisir Plan',
      contactSales: 'Contacter Ventes',
      monthlyFee: '+ €99/mois maintenance',
      languagesSupported: 'Langues supportées : EN, ES, IT, FR, PT, DE',
      plans: {
        basic: {
          name: 'Basique',
          description: 'Pour les entreprises qui commencent leur transformation digitale.',
          features: ['1 catégorie/vertical', 'Support WhatsApp', 'Panneau basique', 'Tâches IA initiales', 'Support email'],
        },
        advanced: {
          name: 'Avancé',
          description: 'Pour les entreprises cherchant l\'automatisation totale.',
          features: ['Catégories multiples', 'Menu digital + PDF + QR', 'Programmation et stock', 'Multi-langue', 'Backend éditorial', 'Support prioritaire'],
        },
        custom: {
          name: 'Personnalisé',
          description: 'Solution évolutive sans limites.',
          features: ['Modules illimités', 'Automatisation totale', 'Voyage, coworking, ateliers', 'Contenu généré par IA', 'Support dédié', 'Intégrations custom'],
        },
      },
    },
    cta: {
  ...
  pt: {
    ...
    pricing: {
      sectionLabel: 'Preços',
      sectionTitle: 'Planos projetados para crescer',
      sectionSubtitle: 'Das primeiras reservas à automação total. Escolha seu ponto de partida.',
      popular: 'Mais Popular',
      startAt: 'A partir de',
      selectPlan: 'Escolher Plano',
      contactSales: 'Contatar Vendas',
      monthlyFee: '+ €99/mês manutenção',
      languagesSupported: 'Idiomas suportados: EN, ES, IT, FR, PT, DE',
      plans: {
        basic: {
          name: 'Básico',
          description: 'Para negócios que iniciam sua transformação digital.',
          features: ['1 categoria/vertical', 'Suporte WhatsApp', 'Painel básico', 'Tarefas IA iniciais', 'Suporte email'],
        },
        advanced: {
          name: 'Avançado',
          description: 'Para negócios que buscam automação total.',
          features: ['Categorias múltiplas', 'Menu digital + PDF + QR', 'Programação e estoque', 'Multi-idioma', 'Backend editorial', 'Suporte prioritário'],
        },
        custom: {
          name: 'Personalizado',
          description: 'Solução escalável sem limites.',
          features: ['Módulos ilimitados', 'Automação total', 'Viagem, coworking, workshops', 'Conteúdo gerado por IA', 'Suporte dedicado', 'Integrações custom'],
        },
      },
    },
    cta: {
  ...
  de: {
    ...
    pricing: {
      sectionLabel: 'Preise',
      sectionTitle: 'Pläne für Wachstum konzipiert',
      sectionSubtitle: 'Von ersten Reservierungen bis zur vollständigen Automatisierung. Wählen Sie Ihren Ausgangspunkt.',
      popular: 'Am beliebtesten',
      startAt: 'Ab',
      selectPlan: 'Plan wählen',
      contactSales: 'Vertrieb kontaktieren',
      monthlyFee: '+ €99/Monat Wartung',
      languagesSupported: 'Unterstützte Sprachen: EN, ES, IT, FR, PT, DE',
      plans: {
        basic: {
          name: 'Basis',
          description: 'Für Unternehmen, die ihre digitale Transformation beginnen.',
          features: ['1 Kategorie/Vertikal', 'WhatsApp Support', 'Basis-Panel', 'Erste KI-Aufgaben', 'E-Mail Support'],
        },
        advanced: {
          name: 'Erweitert',
          description: 'Für Unternehmen, die vollständige Automatisierung suchen.',
          features: ['Mehrere Kategorien', 'Digitales Menü + PDF + QR', 'Planung und Lager', 'Mehrsprachig', 'Redaktionelles Backend', 'Prioritäts-Support'],
        },
        custom: {
          name: 'Individuell',
          description: 'Skalierbare Lösung ohne Grenzen.',
          features: ['Unbegrenzte Module', 'Vollständige Automatisierung', 'Reisen, Coworking, Workshops', 'KI-generierter Content', 'Dedizierter Support', 'Custom Integrationen'],
        },
      },
    },
    cta: {
